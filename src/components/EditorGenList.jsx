        ...
        return (
            <div className="flex flex-col gap-4 p-4 px-4 mt-5">
                ...
                <div className="flex justify-center text-xs mt-5">
                    <button
                        className="border-2 border-slate-700 hover:bg-slate-800 text-slate-400 px-4 py-2 rounded-lg cursor-pointer transition-all duration-200 active:scale-95 shadow-sm hover:shadow-md"
                        onClick={handleClose}
                    >
                        Close
                    </button>
